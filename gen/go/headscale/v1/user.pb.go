...
type User struct {
	...
	// Role controls access level: "owner", "admin", "member", "service_account".
...
// SetUserRole changes a user's role (owner/admin/member/service_account).
...
func (x *SetUserRoleRequest) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
// SetUserCredentials creates or updates local auth credentials for a user.
// This allows the user to log in to the web UI with a password.
...
func (x *SetUserCredentialsRequest) GetUserId() uint64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *SetUserCredentialsRequest) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
type SetUserCredentialsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SetUserCredentialsResponse) Reset() {
	*x = SetUserCredentialsResponse{}
	mi := &file_headscale_v1_user_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SetUserCredentialsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetUserCredentialsResponse) ProtoMessage() {}

func (x *SetUserCredentialsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_headscale_v1_user_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetUserCredentialsResponse.ProtoReflect.Descriptor instead.
func (*SetUserCredentialsResponse) Descriptor() ([]byte, []int) {
...
const file_headscale_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x17headscale/v1/user.proto\x12\fheadscale.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\x97\x02\n" +
	"\x04User\x12\x0e\n" +
	...
	"\x0fprofile_pic_url\x18\b \x01(\tR\rprofilePicUrl\x12\x12\n" +
	"\x04role\x18\t \x01(\tR\x04role\"\x81\x01\n" +
	...
	"\x05users\x18\x01 \x03(\v2\x12.headscale.v1.UserR\x05users\"8\n" +
	"\x12SetUserRoleRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x04R\x02id\x12\x12\n" +
	"\x04role\x18\x02 \x01(\tR\x04role\"=\n" +
	"\x13SetUserRoleResponse\x12&\n" +
	"\x04user\x18\x01 \x01(\v2\x12.headscale.v1.UserR\x04user\"P\n" +
	"\x19SetUserCredentialsRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x04R\x06userId\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\"\x1c\n" +
	"\x1aSetUserCredentialsResponseB)Z'github.com/juanfont/headscale/gen/go/v1b\x06proto3"
...
var file_headscale_v1_user_proto_goTypes = []any{
	...
	(*SetUserRoleRequest)(nil),         // 9: headscale.v1.SetUserRoleRequest
	(*SetUserRoleResponse)(nil),        // 10: headscale.v1.SetUserRoleResponse
	(*SetUserCredentialsRequest)(nil),  // 11: headscale.v1.SetUserCredentialsRequest
	(*SetUserCredentialsResponse)(nil), // 12: headscale.v1.SetUserCredentialsResponse
...
var file_headscale_v1_user_proto_depIdxs = []int32{
	...
	0,  // 4: headscale.v1.SetUserRoleResponse.user:type_name -> headscale.v1.User
