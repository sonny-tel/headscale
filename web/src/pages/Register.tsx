      ...
      <div style={{ width: 460, maxWidth: "100%" }}>
        ...
        {status === "done" ? (
          ...
          >
            ...
            <h3 style={{ fontSize: "1rem", marginBottom: "0.375rem" }}>Machine Registered</h3>
            <p className="text-sm text-secondary" style={{ marginBottom: "1.25rem" }}>
              The device has been approved and will connect to your tailnet shortly.
            </p>
            <a
              href="/admin"
          ...
          >
            ...
            <div style={{ marginBottom: "1rem" }}>
              ...
              <div
                className="copy-box"
                onClick={() => {
                  const cmd = `headscale nodes register --user USER --key ${authId}`;
                ...
                title="Click to copy"
              >
                <code style={{ fontSize: "0.8125rem", wordBreak: "break-all", color: "var(--color-text)", flex: 1 }}>
                  headscale nodes register --user USER --key {authId}
                </code>
            ...
            <div style={{ display: "flex", gap: "0.625rem", marginTop: "0.5rem" }}>
              <a
                ...
                style={{ flex: 1, borderRadius: "var(--radius-lg)", padding: "0.625rem 1rem", fontSize: "0.875rem", textDecoration: "none" }}
              >
                Cancel
              </a>
              <button
